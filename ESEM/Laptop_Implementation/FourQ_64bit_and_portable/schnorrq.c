...
{ // SchnorrQ keypair generation
  ...
  // Outputs: 32-byte SecretKey and 32-byte PublicKey
    ECCRYPTO_STATUS Status = ECCRYPTO_ERROR_UNKNOWN;
    clock_t randomTime, randomTime1, randomTime2;
   ...
   randomTime2 = clock();
     //   randomTime = randomTime +(double)(randomTime2-randomTime1);
 ...
 // }
//printf(" %fus per radnom\n", ((double) (randomTime * 1000)) / CLOCKS_PER_SEC / 1024 * 1000);
